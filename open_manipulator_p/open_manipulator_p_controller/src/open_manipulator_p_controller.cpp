...
OpenManipulatorPController::~OpenManipulatorPController()
{
  ...
  open_manipulator_p_.disableAllActuator(); // Comment out for safety reason
}
...
void OpenManipulatorPController::init_parameters()
{
  ...
  this->declare_parameter("sim", false);/*, rcl_interfaces::msg::ParameterDescriptor(), false);*/
  this->declare_parameter("control_period", 0.010);/*, rcl_interfaces::msg::ParameterDescriptor(), false);*/
  this->declare_parameter("with_gripper", true);/*, rcl_interfaces::msg::ParameterDescriptor(), false);*/
